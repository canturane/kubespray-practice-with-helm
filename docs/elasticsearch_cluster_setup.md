...
Soru sorarsa `y` ile onaylayın.

### 8.2 Config'i Düzenle

Enrollment token bazı ayarları otomatik yazar ama Kubernetes ortamında IP sorunları oluşur. Hatalı satırları temizlemeyi ihmal etmeyin.
